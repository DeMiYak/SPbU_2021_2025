...
Первое --- как каждый из графиков 1-3 показывает (подтверждает), что есть сильная разделимость? (у вас нет комментариев) +
...
Про шум не поняла. Шум --- случайная составляющая, для него теоретически вы не можете получить результат, но можете продемонстрировать, что при увеличении N точность выделения компонент возрастает. +
