#ifndef RRR_H_INCLUDED
#define RRR_H_INCLUDED
...
void rb_rotate_left (rb_tree *t, rb_node *x, int at);// Левое вращение дерева t вокруг узла x

void rb_rotate_right (rb_tree *t, rb_node *x, int at);// Правое вращение дерева t вокруг узла x
